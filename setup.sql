CREATE TABLE IF NOT EXISTS event_types (
    event_name PRIMARY KEY VARCHAR(20),
    event_description VARCHAR(255)
);

INSERT INTO event_types (event_id, event_name, event_description) VALUES (0, "tor_fetch", "Hosts information was fetched from Tor Project resources.");
INSERT INTO event_types (event_id, event_name, event_description) VALUES (1, "shodan_fetch", "Hosts information was fetched with Shodan.");

CREATE TABLE IF NOT EXISTS events
(
    id SERIAL PRIMARY KEY,
    ts TIMESTAMP WITH TIME ZONE NOT NULL,
    event_name SMALLINT NOT NULL REFERENCES event_types(event_name),
...
CREATE TABLE IF NOT EXISTS tor (
    ...
    FOREIGN KEY (ip_addr, or_port) REFERENCES open_ports(ip_addr, port)
);
